...
data_files = [
    ...
    ("/usr/share/pardus/pardus-about/src", ["src/main.py", "src/MainWindow.py", "src/GPU.py", "src/dump_system_info.sh", "src/get_system_info.sh", "src/copy_to_desktop.sh", "src/dump_logs.sh"]),
